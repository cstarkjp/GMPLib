...
def create_directories(results_path: Tuple[str,str]=('..','Results'),
                       results_dir: str='Demo') -> str:
    """
...
def export_results( results_dir: PathLike,
                    filename: PathLike,
                    raw_dict: Dict,
                    suffix: str='' ) -> None:
    """
    ...
    Tries to ensure all dictionary entries are serializable by running `latex`
    ...
    Args:
        ...
        raw_dict: dictionary of results, possibly requiring conversion
            from latex form such that serialization into a JSON file is possible
    """
    serializable_dict = {}
...
def export_plots(fig_dict: Dict,
