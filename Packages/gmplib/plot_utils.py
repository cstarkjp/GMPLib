...
class GraphingBase():
    ...
    def __init__(self, dpi=100, font_size=11) -> None:
        """
        Constructor method.
    ...
    @staticmethod
    def covector_fishbone_vertical(x,y, px,py, ref, fishbone_len,
                                   n_ticks=5, sf=1, color='DarkBlue') -> None:
        """
        TBD
        """
    ...
    @staticmethod
    def covector_fishbone(x,y, px,py, ref, fishbone_len,
                          n_ticks=5, sf=1, color='DarkBlue') -> None:
        """
        TBD
        """
